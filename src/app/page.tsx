                ...
                <div className="text-center lg:text-left space-y-3 w-full">
                  ...
                  <div className="pt-4 border-t space-y-2 text-sm">
                    <p className="flex items-center gap-2 justify-center lg:justify-start">
                      ...
                      <a href="mailto:jrm@jrmlegal.de" className="text-foreground hover:text-primary transition-colors">
                        jrm@jrmlegal.de
                      </a>
                    </p>
                    <p className="flex items-center gap-2 justify-center lg:justify-start">
                      ...
                      <a href="tel:+491777983780" className="text-foreground hover:text-primary transition-colors">
                        +49 177 7983780
                      </a>
                    </p>
                  </div>
                  ...
                  <div className="p-8 bg-card border-2 rounded shadow-sm space-y-4">
                    ...
                    <div className="text-base space-y-2 pt-4 border-t">
                      <p className="flex items-center gap-2">
                        ...
                        <a href="mailto:jrm@jrmlegal.de" className="text-primary hover:underline font-medium">
                          jrm@jrmlegal.de
                        </a>
                      </p>
                      <p className="flex items-center gap-2">
                        ...
                        <a href="tel:+491777983780" className="text-primary hover:underline font-medium">
                          +49 177 7983780
                        </a>
                      </p>
                    </div>
